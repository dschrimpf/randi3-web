...
case class RandomizationMethodConfigTmp(id: Int = Int.MinValue, version: Int = 0, name: String, i18nName: String, description: String, canBeUsedWithStratification: Boolean, configurationEntries: List[RandomizationMethodConfigEntryTmp[Any]], stages: Map[String, List[Criterion[_, Constraint[_]]]]) {
